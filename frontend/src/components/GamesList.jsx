...
export default function GamesList(){
    ...
    const gameComponent = (game)=>{
        ...
        return (
            <div key={game.id} className="card bg-base-200 w-80 transition-all shadow-md hover:shadow-sm hover:shadow-amber-700 shadow-red-100 p-0 hover:bg-base-700 text-white m-3">
                <figure>
                    <img
                    src={ game.picture }
                    alt="Game name"
